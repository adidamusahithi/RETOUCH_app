...
public class Edit_i extends Activity {
    Button ro1, ro2, ro3, ro4, ro5, ro6, ro7, ro8, ro9, ro10, ro11, ro12, ro13,col_line;
    ImageButton backButton, saveButton;
    Paint paint;
    ImageView viewImage;
    Bitmap mBitmap, bBitmap, cBitmap, thumbnail, change;
    Uri uri;
    String    selectedimagepath, img_a;
    TextView tv;
    File imageFile;
    String path_p;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        col_line = (Button) findViewById(R.id.color);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(Edit_i.this,FirstActivity.class);
                startActivity(i);
        ...
        col_line.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               // Intent inti = new Intent(Edit_i.this, Col_line.class);
                //startActivity(inti);
                String ImagePath = MediaStore.Images.Media.insertImage(
                        getContentResolver(),change
                        ,
                        "demo_image",
                        "demo_image"
                );
                ...
                Intent intent = new Intent(Edit_i.this,Col_line.class);
